(function () {
    $(document).on('oauthregistrationinit.cms.app', function (e) {
        ...
        try {
            ...
            if (trigger == 'RedirectUri' && data.RedirectUri) {
                var newUri = validateRedirectUri(data.RedirectUri, data.AuthenticationType);
                ...
                var newUri = validateRedirectUri(data.LocalRedirectUri, data.AuthenticationType, true);
    ...
    function configToText(data) {
        ...
        if (data.AuthenticationType.match(/dnn|sharepoint|identityserver/))
        ...
        if (data.AuthenticationType == 'identityserver' && data.Scope)
